...
var StoreLocal = require('./server/store/local');
var StoreS3 = require('./server/store/s3');
var middleware = require('./middleware');
var ConfigFile = require('./server/settings/file');
...
var superstatic = module.exports = function (options) {
  ...
  app.start = function (cb) {
    ...
    app.use(middleware.services(this._services, this._servicesRoutePrefix));
...
superstatic.defaultSettings = require('./server/settings/default');
