...
module.exports = function() {
  return function(req, res, next) {
    ...
    res.superstatic.provider(req, pathname).then(function(result) {
      if (result) {
      ...
      return res.superstatic.provider(req, indexPathname).then(function(indexResult) {
        if (indexResult && hasTrailingSlash) {
          return res.superstatic.handleFileStream({file: indexPathname}, indexResult);
