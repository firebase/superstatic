...
var legacyCompress = require('compression')();
var shrinkRay;
try {
  shrinkRay = require('shrink-ray')();
} catch (err) {
  console.log('Warning: advanced compression encodings unavailable without ES6. Falling back to gzip.');
  shrinkRay = null;
}
