var protect = function () {
  return  function (req, res, next) {
    ...
    var envConfig = protect.envConfig(req);
...
protect.envConfig = function (req) {
  return (req.ss.settings.build && req.ss.settings.build.env) ? req.ss.settings.build.env.config : undefined;
};
