...
module.exports = function stacker (app, options) {
  ...
  return function (req, res, next) {
    ...
    var errorPage = (config.error_page) ? path.join(cwdRoot, config.error_page) : DEFAULT_ERROR_PAGE;
    ...
    stack.use(notFound(errorPage, _.extend(middlewareOptions, {_default: DEFAULT_ERROR_PAGE})));
