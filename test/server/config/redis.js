...
// process.env.API_HOST = 'https://api.divshot.com';
// var config = new ConfigRedis(redisOptions);

// config.load('scottcorgan.divshot.io', function (err, release) {
...
describe.only('Redis - remote settings', function() {
